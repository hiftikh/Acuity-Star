...
public:
    ...
    static bool setupPieChart(PieChartWidget *pieChart, QListWidget *pieListWidget, std::vector<std::pair<std::string, double> > pieChartList);
    static bool setupBarChart(QCustomPlot *barChart, std::vector<std::pair<std::string, double> > barChartList);
    static bool setupLineChart(QCustomPlot *lineChart, std::vector<std::pair <std::string, double>> lineChartList);
    static bool setupStackedBarChart(QCustomPlot *stackedBarChart, std::vector<std::pair<std::string, double> > stackedBarCharList);
    ~MainWindow();
...
private slots:
    ...
    void on_teach_sort_selection_clicked();
    void on_teach_sort_cancel_clicked();
    void on_teach_sort_apply_clicked();
    ...
    void on_teach_stacked_bar_button_clicked();

    void on_pub_stacked_bar_button_clicked();

    void on_pres_stacked_bar_button_clicked();

    void on_fund_stacked_bar_button_clicked();

    void on_teach_search_textChanged(const QString &arg1);

    void on_pub_search_textChanged(const QString &arg1);

    void on_pres_search_textChanged(const QString &arg1);

    void on_grant_search_textChanged(const QString &arg1);

    void on_pub_sort_selection_clicked();
    void on_pub_sort_cancel_clicked();
    void on_pub_sort_apply_clicked();
    void on_pres_sort_selection_clicked();
    void on_pres_sort_cancel_clicked();
    void on_pres_sort_apply_clicked();
    void on_fund_sort_selection_clicked();
    void on_fund_sort_cancel_clicked();
    void on_fund_sort_apply_clicked();
private:
    QList<int> userSelectedRows;
    bool refreshOnUserSelect;
    ...
    QString lastTeachFile = "";
    QString lastPubFile = "";
    QString lastPresFile = "";
    QString lastGrantFile = "";
